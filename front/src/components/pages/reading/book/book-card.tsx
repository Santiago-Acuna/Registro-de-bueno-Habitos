...
import styles from "./books-card.module.css";
            ...
            <div className={styles.flipCardback}>
              <div className={styles.cardbackSection}>
                <p className={styles.namep}>
                  Total pages: {book.total_pages ? book.total_pages : "no info"}
                </p>
              </div>
              <div className={styles.cardbackSection}>
                <p className={styles.namep}>
                  Current page:{" "}
                  {book.current_page ? book.current_page : "no info"}
                </p>
              </div>
              <div className={styles.cardbackSection}>
                <div>
                  {" "}
                  Grid con voz sin voz average_of_characters_per_minute
